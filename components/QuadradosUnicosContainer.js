...
const QuadradosUnicosContainer = ({ dados }) => {
    ...
    const calcularQuadradosPorLinha = () => {
      if (containerRef.current) {
        ...
        const larguraQuadrado = dados.length > 0 ? containerRef.current.children[0].children[0].clientWidth : 0;
  ...
  export default QuadradosUnicosContainer;